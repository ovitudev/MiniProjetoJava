...
public class AdminView {
    ...
    // Metódo responsável por realizar o cadastro de um usuário do tipo Administrador, pedindo o parâmetro da classe
    // AdminController e da Listra do construtor dessa classe
    public void registrationAdmin(AdminController adminController, List<AdminModel> adminModelList){
        ...
        } else if (name.length() < 3) { // Verificação de mínimo de characters aceitos pelo sistema
        ...
        // Passo as informações digitas pelo usuário para a lista de Admin
        adminController.registrationAdmin(name, cpf, email, id, accessLevel);
    }

    // Metódo responsável por exibir a lista de Administradores cadastrados
    ...
    public void showAdministrators(AdminController adminController){
        ...
        //Verifica se a lista está vazia, se sim apresenta uma mensagem, se não, apresenta a lista de Administradores
